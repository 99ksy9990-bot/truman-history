...
해리 S. 트루먼의 주요 결정과 한국전쟁을 다룬 역사 발표 자료입니다.

## 파일

- `index.html` - 웹에서 바로 보는 7면 발표 자료
- `트루먼_3분_발표_지면형.html` - 원본 파일명으로 보관한 HTML
- `트루먼_3분_발표_지면형.pdf` - 7면 발표 자료 PDF
- `트루먼_발표대본_3분30초.pdf` - 3분 30초 발표 대본 PDF
